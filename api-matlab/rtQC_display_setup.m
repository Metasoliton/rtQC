...
gui_data.panel_roi = uipanel('Parent', gui_data.tab_pre,...
    ...
    'fontsize', gui_data.standard_font_size);
gui_data.panel_compdata = uipanel('Parent', gui_data.tab_pre,...
    'Title','Compare data',...
    'Position',[.5 .6 .45 .38],...
    'fontsize', gui_data.standard_font_size);
...
gui_data.txt_ROI1 = uicontrol('Parent', gui_data.panel_roi,...
    'Style','text',...
    'String','ROI 1 .nii',...
    'Units', 'Normalized',...
    'Position',[0.02 0.82 0.15 0.10],...
    'HorizontalAlignment', 'left',...
    'fontsize', gui_data.small_font_size);
gui_data.edit_ROI1 = uicontrol('Parent', gui_data.panel_roi,...
    'Style', 'edit',...
    'String', '', ...
    'Units', 'Normalized',...
    'Position', [0.18 0.82 0.73 0.10],...
    ...
    'HorizontalAlignment', 'left',...
    'fontsize', gui_data.button_font_size);
gui_data.pb_ROI1 = uicontrol('Parent', gui_data.panel_roi,...
    'Style', 'push',...
    'String', '...', ...
    'Units', 'Normalized',...
    'Position', [0.92 0.82 0.06 0.10],...
...
gui_data.txt_ROI2 = uicontrol('Parent', gui_data.panel_roi,...
    'Style','text',...
    'String','ROI 2 .nii',...
    'Units', 'Normalized',...
    'Position',[0.02 0.66 0.15 0.10],...
    'HorizontalAlignment', 'left',...
    'fontsize', gui_data.small_font_size);
gui_data.edit_ROI2 = uicontrol('Parent', gui_data.panel_roi,...
    'Style', 'edit',...
    'String', '', ...
    'Units', 'Normalized',...
    'Position', [0.18 0.66 0.73 0.10],...
    ...
    'HorizontalAlignment', 'left',...
    'fontsize', gui_data.button_font_size);
gui_data.pb_ROI2 = uicontrol('Parent', gui_data.panel_roi,...
    'Style', 'push',...
    'String', '...', ...
    'Units', 'Normalized',...
    'Position', [0.92 0.66 0.06 0.10],...
...
% Compare Data panel UIcontrols
gui_data.txt_DATA1 = uicontrol('Parent', gui_data.panel_compdata,...
    'Style','text',...
    'String','4D DATA 1 .nii',...
    'Units', 'Normalized',...
    'Position',[0.02 0.82 0.15 0.10],...
    'HorizontalAlignment', 'left',...
    'fontsize', gui_data.small_font_size);
gui_data.edit_DATA1 = uicontrol('Parent', gui_data.panel_compdata,...
    'Style', 'edit',...
    'String', '', ...
    'Units', 'Normalized',...
    'Position', [0.18 0.82 0.73 0.10],...
    ...
    'HorizontalAlignment', 'left',...
    'fontsize', gui_data.button_font_size);
gui_data.pb_DATA1 = uicontrol('Parent', gui_data.panel_compdata,...
    'Style', 'push',...
    'String', '...', ...
    'Units', 'Normalized',...
    'Position', [0.92 0.82 0.06 0.10],...
    ...
    'UserData', 0,...
    'fontsize', gui_data.button_font_size);
gui_data.txt_DATA2 = uicontrol('Parent', gui_data.panel_compdata,...
    'Style','text',...
    'String','4D DATA 2 .nii',...
    'Units', 'Normalized',...
    'Position',[0.02 0.66 0.15 0.10],...
    'HorizontalAlignment', 'left',...
    'fontsize', gui_data.small_font_size);
gui_data.edit_DATA2 = uicontrol('Parent', gui_data.panel_compdata,...
    'Style', 'edit',...
    'String', '', ...
    'Units', 'Normalized',...
    'Position', [0.18 0.66 0.73 0.10],...
    ...
    'HorizontalAlignment', 'left',...
    'fontsize', gui_data.button_font_size);
gui_data.pb_DATA2 = uicontrol('Parent', gui_data.panel_compdata,...
    'Style', 'push',...
    'String', '...', ...
    'Units', 'Normalized',...
    'Position', [0.92 0.66 0.06 0.10],...
...
gui_data.txt_tsnr_gm = uicontrol('Parent', gui_data.panel_rtvalues,...
    ...
    'HorizontalAlignment', 'left',...
    'fontsize', gui_data.vals_font_size);
gui_data.txt_tsnr_ROI1 = uicontrol('Parent', gui_data.panel_rtvalues,...
    'Style','text',...
    'String','tSNR (ROI 1):  0',...
    'Units', 'Normalized',...
    ...
    'HorizontalAlignment', 'left',...
    'fontsize', gui_data.vals_font_size);
gui_data.txt_tsnr_ROI2 = uicontrol('Parent', gui_data.panel_rtvalues,...
    'Style','text',...
    'String','tSNR (ROI 2):  0',...
    'Units', 'Normalized',...
...
gui_data.panel_compresults = uipanel('Parent', gui_data.tab_post,...
    'Title','Compare results',...
    'Position',[.5 .6 .45 .38],...
    'fontsize', gui_data.standard_font_size);

% Compare Data panel UIcontrols
gui_data.txt_RES1 = uicontrol('Parent', gui_data.panel_compresults,...
    'Style','text',...
    'String','3D IMG 1 .nii',...
    'Units', 'Normalized',...
    'Position',[0.02 0.82 0.15 0.10],...
    'HorizontalAlignment', 'left',...
    'fontsize', gui_data.small_font_size);
gui_data.edit_RES1 = uicontrol('Parent', gui_data.panel_compresults,...
    'Style', 'edit',...
    'String', '', ...
    'Units', 'Normalized',...
    'Position', [0.18 0.82 0.73 0.10],...
    ...
    'HorizontalAlignment', 'left',...
    'fontsize', gui_data.button_font_size);
gui_data.pb_RES1 = uicontrol('Parent', gui_data.panel_compresults,...
    'Style', 'push',...
    'String', '...', ...
    'Units', 'Normalized',...
    'Position', [0.92 0.82 0.06 0.10],...
    ...
    'UserData', 0,...
    'fontsize', gui_data.button_font_size);
gui_data.txt_RES2 = uicontrol('Parent', gui_data.panel_compresults,...
    'Style','text',...
    'String','3D IMG 2 .nii',...
    'Units', 'Normalized',...
    'Position',[0.02 0.66 0.15 0.10],...
    'HorizontalAlignment', 'left',...
    'fontsize', gui_data.small_font_size);
gui_data.edit_RES2 = uicontrol('Parent', gui_data.panel_compresults,...
    'Style', 'edit',...
    'String', '', ...
    'Units', 'Normalized',...
    'Position', [0.18 0.66 0.73 0.10],...
    ...
    'HorizontalAlignment', 'left',...
    'fontsize', gui_data.button_font_size);
gui_data.pb_RES2 = uicontrol('Parent', gui_data.panel_compresults,...
    'Style', 'push',...
    'String', '...', ...
    'Units', 'Normalized',...
    'Position', [0.92 0.66 0.06 0.10],...
